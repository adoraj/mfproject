		...
		<div class="main">
	        ...
	        <tbody>
	        	...
	        	<tr <?php _e($i);?>>
	                ...
	                <td>
	                   <?php _e(htmlspecialchars(get_magic_quotes_gpc()?stripslashes($item['seach']):$item['seach']))?>
	                </td>
	                <td>
	                    <?php _e(htmlspecialchars(get_magic_quotes_gpc()?stripslashes($item['replace']):$item['replace']))?>
	                </td>
	            </tr>
	        			<?php
	        		}
